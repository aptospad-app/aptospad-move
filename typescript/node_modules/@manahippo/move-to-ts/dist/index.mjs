import { HexString, BCS, TxnBuilderTypes, TransactionBuilderEd25519, AptosClient } from 'aptos';
...
function isAtomicTypeTag(val) {
    return (typeof val === 'string' && Object.values(AtomicTypeTag).includes(val));
}
class StructTag$1 {
...
U64.MIN = bigInt(0);
U64.MAX = bigInt("18446744073709551615");
...
U128.MIN = bigInt(0);
U128.MAX = bigInt("340282366920938463463374607431768211455");
...
[
    {
        name: "name",
        typeTag: new StructTag$1(new HexString("0x1"), "string", "String", []),
    },
    {
        name: "source",
        typeTag: new StructTag$1(new HexString("0x1"), "string", "String", []),
...
PackageMetadata.moduleAddress = new HexString("0x1");
...
PackageMetadata.fields = [
    ...
    {
        name: "upgrade_policy",
        typeTag: new StructTag$1(new HexString("0x1"), "code", "UpgradePolicy", []),
    },
    {
        name: "manifest",
        typeTag: new StructTag$1(new HexString("0x1"), "string", "String", []),
    ...
    {
        name: "modules",
        typeTag: new VectorTag(new StructTag$1(new HexString("0x1"), "code", "ModuleMetadata", [])),
    },
];
class UpgradePolicy {
    constructor(proto, typeTag) {
...
UpgradePolicy.moduleAddress = new HexString("0x1");
...
ActualUsage.moduleAddress = new HexString("0x1");
...
ActualAggregator.moduleAddress = new HexString("0x1");
...
ActualTypeInfoClass.moduleAddress = new HexString("0x1");
...
ActualStringClass.moduleAddress = new HexString("0x1");
...
function aptos_std_type_info_type_of($c, tags) {
    ...
    const struct_name = tag.typeParams.length > 0
        ...
        : tag.name;
    const newTag = new StructTag$1(new HexString("0x1"), "TypeInfo", "TypeInfo", []);
...
function aptos_std_type_info_type_name($c, tags) {
    ...
    const tag = tags[0];
    const newTag = new StructTag$1(new HexString("0x1"), "string", "String", []);
...
// Copyright (c) Aptos
const { TypeTagBool, TypeTagU8, TypeTagU64, TypeTagU128, TypeTagAddress, AccountAddress: AccountAddress$1, TypeTagVector, TypeTagStruct, StructTag, Identifier: Identifier$1, TransactionArgumentBool, TransactionArgumentU64, TransactionArgumentU128, TransactionArgumentAddress, TransactionArgumentU8, TransactionArgumentU8Vector, } = TxnBuilderTypes;
...
export { ActualAggregator, ActualStringClass, ActualUsage, AddressParser, AptosLocalCache, AptosParserRepo, AptosResourceCache, AptosSyncedCache, AptosVectorU8, AtomicTypeTag, BoolParser, DummyCache, PackageMetadata, SIM_KEYS, SimpleStructTag, StructTag$1 as StructTag, TypeParamIdx, U128, U128Parser, U64, U64Parser, U8, U8Parser, UnsignedInt, UpgradePolicy, VectorParser, VectorTag, abortCode, aptos_framework_account_create_address, aptos_framework_account_create_signer, aptos_framework_aggregator_add, aptos_framework_aggregator_destroy, aptos_framework_aggregator_factory_new_aggregator, aptos_framework_aggregator_read, aptos_framework_aggregator_sub, aptos_framework_code_request_publish, aptos_framework_code_request_publish_with_allowed_deps, aptos_framework_event_write_to_event_store, aptos_framework_genesis_create_signer, aptos_framework_state_storage_get_state_storage_usage_only_at_epoch_beginning, aptos_framework_transaction_context_get_script_hash, aptos_framework_util_from_bytes, aptos_std_any_from_bytes, aptos_std_aptos_hash_keccak256, aptos_std_aptos_hash_ripemd160_internal, aptos_std_aptos_hash_sha2_512_internal, aptos_std_aptos_hash_sip_hash, aptos_std_bls12381_aggregate_pubkeys_internal, aptos_std_bls12381_aggregate_signatures_internal, aptos_std_bls12381_signature_subgroup_check_internal, aptos_std_bls12381_validate_pubkey_internal, aptos_std_bls12381_verify_aggregate_signature_internal, aptos_std_bls12381_verify_multisignature_internal, aptos_std_bls12381_verify_normal_signature_internal, aptos_std_bls12381_verify_proof_of_possession_internal, aptos_std_bls12381_verify_signature_share_internal, aptos_std_debug_print, aptos_std_debug_print_stack_trace, aptos_std_ed25519_public_key_validate_internal, aptos_std_ed25519_signature_verify_strict_internal, aptos_std_event_write_to_event_store, aptos_std_from_bcs_from_bytes, aptos_std_multi_ed25519_public_key_validate_internal, aptos_std_multi_ed25519_signature_verify_strict_internal, aptos_std_secp256k1_ecdsa_recover, aptos_std_secp256k1_ecdsa_recover_internal, aptos_std_table_add_box, aptos_std_table_borrow_box, aptos_std_table_borrow_box_mut, aptos_std_table_contains_box, aptos_std_table_destroy_empty_box, aptos_std_table_drop_unchecked_box, aptos_std_table_new_table_handle, aptos_std_table_remove_box, aptos_std_type_info_chain_id_internal, aptos_std_type_info_type_name, aptos_std_type_info_type_of, assert, buildPayload, copy, deep_eq, deserializeMoveValue, dyn_add, dyn_and, dyn_bitand, dyn_bitor, dyn_div, dyn_eq, dyn_ge, dyn_gt, dyn_le, dyn_lt, dyn_mod, dyn_mul, dyn_neq, dyn_or, dyn_shl, dyn_shr, dyn_sub, dyn_xor, generateBCSSimulation, getShortAddressTypeTagFullname, getShortAddressTypeTagParamlessName, getSimulationKeys, getTypeParamsString, getTypeTagFullname, getTypeTagParamlessName, isAtomicTypeTag, isTypeTagConcrete, moveValueToOpenApiObject, numbersOrStringToHexString, parseAtomicTag, parseMoveStructTag, parseQualifiedStructTag, parseResourceType, parseStructProto, parseTypeParameter, parseTypeTag, parseTypeTagOrThrow, parseVectorTag, payloadArg, print, printerReplacer, sendPayloadTx, sendPayloadTxAndLog, serializeMoveValue, serializeMoveValueWithoutTag, serializeStruct, serializeVector, set, simulatePayloadTx, simulatePayloadTxAndLog, std_bcs_to_bytes, std_hash_sha2_256, std_hash_sha3_256, std_signer_borrow_address, std_string_internal_check_utf8, std_string_internal_index_of, std_string_internal_is_char_boundary, std_string_internal_sub_string, std_unit_test_create_signers_for_testing, std_vector_borrow, std_vector_borrow_mut, std_vector_destroy_empty, std_vector_empty, std_vector_length, std_vector_pop_back, std_vector_push_back, std_vector_swap, strToU8, substituteTypeParams, takeBigInt, takeSimulationValue, u128, u64, u8, u8ArrayArg, u8str, veq };
